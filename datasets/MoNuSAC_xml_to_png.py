...
count = 0
data_path = '/media/NAS/nas_70/open_dataset/MoNuSAC/MoNuSAC_ori/MoNuSAC_images_and_annotations'  # Path to read data from
destination_path = '/media/NAS/nas_70/open_dataset/MoNuSAC/MoNuSAC_ori'  # Path to save n-ary masks corresponding to xml files
...
os.chdir(destination_path + '/MoNuSAC_test_mask')  # Create folder named as MoNuSAC_masks
