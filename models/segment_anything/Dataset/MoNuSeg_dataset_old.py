...
class MoNuSeg_weak_dataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.split == 'train':
            ...
            box_label = Image.open(os.path.join('/media/NAS/nas_187/siwoo/2023/SAM_pseudo_label/Box_annotation', img_name)).convert('L')
            box_label = Image.fromarray(np.array(box_label)/255)
